...
void loop()
{
  ...
  char recvChar;
    ...
    while(1)
    {
        ...
        {
//RecvChar all DELETED. I don't think this was applicable to our circuit. also, recvChar not declared
           recvChar = blueToothSerial.read();
           Serial.println(recvChar);
            
        }

        else if(Serial.available())            // Check if there's any data sent from the local serial terminal. You can add the other applications here. POTENTIALLY DELETE till next comment
        {
